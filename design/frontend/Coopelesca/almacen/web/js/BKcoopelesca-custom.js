...
$(document).ready(function(){
  ...
  if( ($("#acciones-menu").length > 0)&&( $(window).width() >= 992 ) ){    
    ...
    var calcularCompraCredito = $("#calcularCompraCredito").html();
    var editarCompraCredito = $("#editarCompraCredito").html();
    var confirmarCompraCredito = $("#confirmarCompraCredito").html();
    var terminosCondicionesCalculadora = $("#terminosCondicionesCalculadora").html();
