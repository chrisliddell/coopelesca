...
return [
    'modules' => [
        ...
        'Amazon_Login' => 1,
        'Amazon_Payment' => 1,
        'Coopelesca_Compare' => 1,
        'Coopelesca_EstadoPedido' => 1,
        'Coopelesca_IngresoAsociados' => 1,
        'Coopelesca_ListadoCarrito' => 1,
        'Coopelesca_ListadoOrden' => 1,
        'Coopelesca_MejorVendidos' => 0,
        'Coopelesca_Ofertas' => 1,
        'Dotdigitalgroup_Email' => 1,
        'Dotdigitalgroup_Enterprise' => 1,
        'Ebizmarts_MailChimp' => 0,
        'Emizentech_Priceslider' => 0,
        'Faonni_ReCaptcha' => 0,
        'Imagineer_Address' => 1,
        'Imagineer_AddressSetup' => 1,
        'Imagineer_CustomCredit' => 1,
        'Imagineer_CustomPayment' => 1,
        'Imagineer_Directory' => 1,
        'Imagineer_Paygate' => 1,
        'Klarna_Core' => 1,
